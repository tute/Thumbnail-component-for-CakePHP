...
The first lines of the component defines many configuration options:
...
* @images_size@: Array of different file sizes required by your app. Each
  ...
  You can define as many options as you like.
...
* Make it work in Windows (DS instead of / as directory separator)
  ("Issue 3":http://github.com/tute/Thumbnail-component-for-CakePHP/issues#issue/3).
